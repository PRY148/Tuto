...
WebUI.setText(findTestObject('Organizacion/Subtipo Global/Crear/textarea_tq_global_subtypenote'), 
    'Esto es una prueba del submodulo de Subtipo global en el version suit.')

WebUI.click(findTestObject('Organizacion/Subtipo Global/Crear/input_btn btn-primary btn-sm'))
