...
WebUI.click(findTestObject('Organizacion/Tipo Global/Eliminar/input_items'))

WebUI.click(findTestObject('Organizacion/Tipo Global/Eliminar/i_fa fa-option-delete'))
