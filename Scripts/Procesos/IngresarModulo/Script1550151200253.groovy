...
WebUI.click(findTestObject('Organizacion/Procesos/Page_Daruma Software  Quality Manag/a_Organizacin'))

WebUI.click(findTestObject('Organizacion/Procesos/Page_/a_Procesos'))
